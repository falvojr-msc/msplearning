 ...
 * adaptation of the bug (java.io.EOFException) already known by Spring and
 * Google HTTP Client.
 * 
 ...
 */
@EActivity
public abstract class AbstractAsyncRestActivity<T extends Application> extends AbstractAsyncActivity<T> {

	/**
	 * Method with loop through each property of type RestClientSupport,
	 * changing its RequestFactory for {@link HttpComponentsClientHttpRequestFactory}.
	 */
	@AfterInject
