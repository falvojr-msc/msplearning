...
public class EducationalContentDemoActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational_content_demo);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                // Create a simple intent that starts the hierarchical parent activity and use NavUtils in the Support Package to ensure proper handling of Up.
    ...
    public static class DemoObjectFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.fragment_edicational_content_object, container, false);
			FragmentActivity activity = getActivity();
			VideoView videoView = (VideoView) rootView.findViewById(R.id.videoView);
			videoView.setVideoURI(Uri.parse("{0}"));
